...
import kayncode.powers.UTPowerAssassin;
...
public class UmbralTrespassAssassin extends AbstractEasyCard implements SpawnModificationCard {
    public final static String ID = makeID(UmbralTrespassAssassin.class.getSimpleName());
...
// You might need to cast the results back to int if necessary
        ...
        this.addToBot(new ApplyPowerAction(m, p, new UTPowerAssassin(m, totalDamage), totalDamage));
