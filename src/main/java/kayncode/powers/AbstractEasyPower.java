...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public static Color greenColor2 = Color.YELLOW.cpy();
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(KaynMod.modID + "Resources/images/powers/" + ID.replaceAll(KaynMod.modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(KaynMod.modID + "Resources/images/powers/" + ID.replaceAll(KaynMod.modID + ":", "") + "84.png");
        if (hiDefImage != null) {
