...
import kayncode.actions.UmbralTrespassAssassinAction;

import static kayncode.KaynMod.makeID;

public class UTPowerAssassin extends AbstractEasyPower {
    public static final String POWER_ID = makeID("UTPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);


    public UTPowerAssassin(AbstractCreature owner, int amount) {
    ...
    public void atEndOfRound() {
        ...
        addToBot(new UmbralTrespassAssassinAction(owner, finalDamage));
