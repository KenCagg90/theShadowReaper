...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(KaynMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(KaynMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(KaynMod.makeImagePath("masks/PowerMask.png"));
